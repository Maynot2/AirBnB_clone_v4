/**
  Fetching places given amenities selection on event click
  and fetch review for a place
**/
  ...
  $('.filters button').click(() => {
    ...
    $.ajax({
      ...
      $('.reviews span').click(function () {
        ...
        // otherwise, delete the placeId from the reviews object and remove reviews from html
        } else {
